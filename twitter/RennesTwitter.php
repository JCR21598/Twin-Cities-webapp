...
//by name and geocode
$getfield = '?q=Rennes&geocode=48.1113387,-1.6800198,25km';
$requestMethod = 'GET';
...
//file path for sentiment analysis
...
$return = '<h5>'. 'Of current Rennes twitter users: '. round(($pos/$tots)*100) . '% are positive';
